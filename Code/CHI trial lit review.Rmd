...
tiff('Studies per year.tiff', res=500, height=3.5, width=3.5, unit='in')

{
  ...
  lines(studies_per_year$year,
        exp(predict(spy_model, 
                data.frame(year=studies_per_year$year))),
        col='red')
  
  text(2016, 3.5, paste('p value: ', round(summary(spy_model)$coefficients[2, 4],
                                           4)),
       col='red')
