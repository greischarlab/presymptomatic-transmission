...
data.lowreplication.nocap$time <- data.lowreplication.nocap$time * 10
data.highreplication.nocap$time <- data.highreplication.nocap$time * 10
data.lowreplication.satimm$time <- data.lowreplication.satimm$time * 10
data.highreplication.satimm$time <- data.highreplication.satimm$time * 10
data.lowreplication.cap$time <- data.lowreplication.cap$time * 10
data.highreplication.cap$time <- data.highreplication.cap$time * 10
