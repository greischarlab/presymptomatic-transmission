...
tiff('Delays varying r.tiff', res=500, width=3.5, height=6.5, unit='in')
{plot.varyingr.nocap <- plot.varyingr(delays.byr.lowsympthresh.nocap, 
              ...
              [delays.byr.medsympthresh.nocap$r==lowrep.nocap | 
                  delays.byr.medsympthresh.nocap$r==highrep.nocap,],
              size=6, 
              ylow=-.06, 
              yhigh=.005, 
              xlow=0, 
  ...
  xlab("") +
  ylab("") +
  geom_text(aes(x=315, y=-0.002, label = "Pre-symptomatic"),
                color="black", size=2) +
  geom_text(aes(x=315, y=0.002, label = "Post-symptomatic"),
                color="black", size=2) +
...
plot.varyingr.satimm <- plot.varyingr(delays.byr.lowsympthresh.satimm, 
              ...
              [delays.byr.medsympthresh.satimm$r==lowrep.satimm | 
                  delays.byr.medsympthresh.satimm$r==highrep.satimm,],
              size=6,
              ylow=-.25, 
              yhigh=0.13, 
              xlow=0, 
...
plot.varyingr.cap <- plot.varyingr(delays.byr.lowsympthresh.cap,
              ...
              [delays.byr.medsympthresh.cap$r==lowrep.cap | 
                  delays.byr.medsympthresh.cap$r==highrep.cap,],
              size=6, 
              ylow=-.05, 
              yhigh=.01, 
              xlow=0, 
