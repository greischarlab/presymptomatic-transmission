...
threshold for symptoms; if pathogen load is above that threshold, then symptoms 
...
tiff('Figure 6.tiff', res=500, width=6.5, height=7.5, unit='in')
{
...
tiff('Figure S6.tiff', res=500, width=3.5, height=5.5, unit='in')
{plot.varyingr.nocap <- plot.varyingr(delays.byr.lowsympthresh.nocap, 
  ...
  xlab("") +
  ylab("") +
  geom_text(aes(x=380, y=-0.003, label = "Pre-symptomatic"),
                color="black", size=2.25) +
  geom_text(aes(x=380, y=0.0035, label = "Post-symptomatic"),
                color="black", size=2.25) +
...
plot.varyingr.satimm <- plot.varyingr(delays.byr.lowsympthresh.satimm, 
  ...
  xlab("") +
  ylab("") +
  geom_text(aes(x=380, y=-0.03, label = "Pre-symptomatic"),
                color="black", size=2.25) +
  geom_text(aes(x=380, y=0.03, label = "Post-symptomatic"),
                color="black", size=2.25) +
...
plot.varyingr.cap <- plot.varyingr(delays.byr.lowsympthresh.cap,
  ...
  geom_text(aes(x=380, y=-0.003, label = "Pre-symptomatic"),
                color="black", size=2.25) +
  geom_text(aes(x=380, y=0.00325, label = "Post-symptomatic"),
                color="black", size=2.25) + 
...
tiff('Figure S8.tiff', res=500, unit='in',
...
```{r, fig.height = 6.5, fig.width = 3.5}
tiff('Figure S7.tiff', res=500, unit='in',
height=6.5, width=3.5)
